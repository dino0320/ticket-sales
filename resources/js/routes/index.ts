...
* @see app/Http/Controllers/CheckoutController.php:31
* @route '/review'
*/
...
* @see app/Http/Controllers/CheckoutController.php:53
* @route '/checkout'
*/
...
* @see app/Http/Controllers/CheckoutController.php:91
